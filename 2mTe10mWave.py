...
url = 'https://apps.ecmwf.int/webapps/opencharts-api/v1/packages/opencharts/products/medium-2t-wind/axis/valid_time/'
headers = {
...
module_name = 'medium-2t-wind'    # 数据名
base_sum = 10   # base_time的数量
valid_sum = 21  # 每个base_time中valid_time的数量
